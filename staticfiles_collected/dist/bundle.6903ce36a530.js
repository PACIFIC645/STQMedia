(function (Swiper, gsap) {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    const galleryEl = document.querySelector('.swiper-container');
    if (galleryEl) {
      console.log('Swiper container found:', galleryEl);

      const swiper = new Swiper('.swiper-container', {
        modules: [Swiper.Navigation, Swiper.Pagination], // Explicitly include required modules
        slidesPerView: 3,
        spaceBetween: 15,
        loop: true,
        autoplay: {
      ...
      swiper.on('init', () => {
        console.log('Swiper is initialized successfully:', swiper);
      });

      console.log('Swiper initialized successfully.');
    } else {
      console.error("🚨 Swiper element not found. Ensure .swiper-container is in your HTML.");
    }
  });
  ...
  // // ----------------------------------
  // // JavaScript Binding for Navigation
  // const galleryEl = document.querySelector('.swiper');
  // if (galleryEl) {
  //   console.log('Swiper found:', galleryEl);
  ...
  //   swiper.on('init', () => {
  //     console.log('Gallery Swiper is ready:', swiper);
  //   });
  // } else {
  //   console.error("🚨 Swiper element not found. Ensure .swiper is in your HTML.");
  // }

})(Swiper, gsap);
//# sourceMappingURL=bundle.js.4cd81d1d8269.map
